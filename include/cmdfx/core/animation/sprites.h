...
extern "C"
{
     ...
     *
     * This method moves a sprite to the given position with an animation. The
     * sprite will move from its current position to the given position over the
     * specified time. The time is in seconds, and the sprite will move at a
     * constant speed. The sprite will be redrawn at each position during the
     * animation.
     *
     ...
     *
     * This method moves a sprite by the given amount with an animation. The
     * sprite will move by the given amount over the specified time. The time is
     * in seconds, and the sprite will move at a constant speed. The sprite will
     * be redrawn at each position during the animation.
     *
     * @param sprite The sprite to move.
