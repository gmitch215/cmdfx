 ...
 * 
 * The size of the array is always 256, with each index corresponding to a key code
 * native to the operating system. If the key is being pressed, the value at the index 
 * will be 1. If the key is not being pressed, the value at the index will be 0.
 * 
