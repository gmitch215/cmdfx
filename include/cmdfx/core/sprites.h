...
extern "C"
{
     ...
     *
     * A sprite is a 2D image that can be drawn to the terminal. It consists of
     * a 2D array of characters that represent the sprite, as well as a Z-index
     * that determines the order in which sprites are drawn. Sprites are useful
     * for keeping track of complex images or animations that need to be drawn
     * to the terminal.
     */
    typedef struct CmdFX_Sprite {
         ...
         * should be the same length, and the number of rows should be equal to
         * the height of the sprite. The sprite will be drawn starting at the X
         * and Y position, with the top-left corner of the sprite at the X and Y
         * position. The number of columns should be equal to the width of the
         * sprite.
         */
        char** data;
         ...
         *
         * This is a 2D array of strings that represent the ANSI codes for the
         * sprite. Each row should be the same length, and the number of rows
         * should be equal to the height of the sprite. The sprite will be drawn
         * starting at the X and Y position, with the top-left corner of the
         * sprite at the X and Y position. The number of columns should be equal
         * to the width of the sprite.
         */
        char*** ansi;
        /**
         * @brief The Z-index of the sprite.
         *
         * This value determines the order in which sprites are drawn. Sprites
         * with a higher Z-index will be drawn on top of sprites with a lower
         * Z-index. If two sprites have the same Z-index, the order in which
         * they are drawn is undefined.
         */
        int z;
        /**
         * @brief The drawing ID of the sprite.
         *
         * This is assigned once the sprite is drawn on the screen. It is used
         * to identify the sprite when editing or removing it. If the sprite is
         * not drawn, this value will be 0. This value will change depending on
         ...
         *
         * This is assigned when the sprite is created. It is used to identify
         * the sprite when editing or removing it. This value will not change.
         */
        int uid;
    } CmdFX_Sprite;
     ...
     *
     * This method returns an array of pointers to the sprites that have been
     * drawn to the terminal. The array is terminated with a `NULL` pointer. The
     * sprites should not be modified or freed by the caller.
     ...
     *
     * This method returns the sprite that is drawn at the given position with
     * the highest Z-index. If there is no sprite at the given position, the
     * method will return `NULL`.
     *
     * @param x The X position.
     * @param y The Y position.
     * @return A pointer to the sprite at the given position, or `NULL` if no
     * sprite is found.
     */
     ...
     * given parameters. The sprite should be freed with `Sprite_free` when it
     * is no longer needed.
     *
     * You can also set `text` and `ansi` to NULL and built them later using
     * `Sprite_setChar`, `Sprite_setAnsi`, and `Sprite_resize`.
     *
     * This method does not draw the sprite to the terminal. To draw the sprite,
     * use the `Sprite_draw` method.
     ...
     *
     * This method draws a sprite to the terminal at the given position. The
     * sprite will be drawn starting at the X and Y position, with the top-left
     * corner of the sprite at the X and Y position. The sprite will be drawn on
     * top of any existing content at that position, according to its Z-index.
     * If it is already drawn, it will be redrawn at the new position.
     *
     ...
     *
     * This method sets the text data for the sprite. The text data should be a
     * 2D array of characters. This will resize the `width` and `height` of the
     * sprite to match the dimensions of the text data. If an error occurs, the
     * method will return 0.
     *
     * If the size is different than `ansi`, the `ansi` will be resized to match
     * the new size. If the new size is larger, the new positions will be filled
     * with NULL. If the new size is smaller, then `ansi` will be cropped from
     * the top-left.
     *
     ...
     * method will return 0.
     *
     * This method will also redraw the character if the sprite is currently
     * drawn.
     * @param sprite The sprite to modify.
     * @param x The X position in the sprite.
     * @param y The Y position in the sprite.
     * @param c The character to set.
     * @return 1 if the character was set, 0 if the position is out of bounds or
     * an error occurred.
     */
     ...
     * fill will start at the given position and fill the specified width and
     * height. If a position is out of bounds, it will be skipped.
     *
     ...
     * height.  If a position is out of bounds, it will be skipped.
     *
     * This method will skip any positions that are already filled with a
     * character. Existing ANSI codes at empty positions will be preserved.
     *
     * This method will also redraw the sprite if it is currently drawn.
     *
     * @param sprite The sprite to modify.
     ...
     *
     * This method sets the character at all positions in the sprite. The
     * character will be set for every position in the sprite, starting from the
     * top-left corner. If an error occurs, the method will return 0.
     *
     * This method will also redraw the sprite if it is currently drawn.
     *
     * @param sprite The sprite to modify.
    ...
    /**
     * @brief Sets the character at all positions in the sprite where there
     * isn't a character.
     *
     * This method sets the character at all positions in the sprite. The
     * character will be set for every position in the sprite, starting from the
     ...
     * @return 1 if the ANSI code was set, 0 if the position is out of bounds or
     * an error occurred.
     */
     ...
     * @return 1 if the ANSI code was appended, 0 if the position is out of
     * bounds or an error occurred.
     */
     ...
     *
     * This method creates a new sprite with the given dimensions. The sprite
     * will be filled with the specified character and ANSI code. The sprite
     ...
     * loaded from the file and the Z-index will be set to the given value. The
     * data from the file will be used, keeping `ansi` empty. The file must be a
     * readable text file. The sprite should be freed with `Sprite_free` when it
     * is no longer needed.
     *
     * This method does not draw the sprite to the terminal. To draw the sprite,
     * use the `Sprite_draw` method.
     ...
     * cropped from the top left. If the new dimensions are larger than the
     * current dimensions, the sprite will be padded with the provided
     * character. If an error occurs, the method will return 0.
     *
     * This method will also redraw the sprite if it is currently drawn.
     * @param sprite The sprite to resize.
     * @param width The new width of the sprite.
     * @param height The new height of the sprite.
     * @param padding The character to pad the sprite with if it is resized
     * larger.
     * @return 1 if the sprite was resized, 0 if an error occurred.
     */
     ...
     * will reposition the `data` and `ansi` characters depending on whether
     * there is whitespace surrounding other characters.
     *
     ...
     *
     * This method returns an array of pointers to the sprites that are
     * colliding with the given sprite. The array is terminated with a `NULL`
     * pointer.
     *
    ...
    /**
     * @brief Gets whether the sprite is the top-most sprite at the given
     * position.
     *
     * This method checks if the sprite is the top-most sprite at the given
     * position. The position is specified by the X and Y coordinates, where (0,
     * 0) is the top-left corner of the sprite. If the position is out of
     * bounds, the method will return 0. "Top-most" refers to the sprite with
     * the highest Z-index.
     *
    ...
    /**
     * @brief Gets whether the sprite is the bottom-most sprite at the given
     * position.
     *
     * This method checks if the sprite is the bottom-most sprite at the given
     * position. The position is specified by the X and Y coordinates, where (0,
     * 0) is the top-left corner of the sprite. If the position is out of
     * bounds, the method will return 0. "Bottom-most" refers to the sprite with
     * the lowest Z-index.
     *
     * @param sprite The sprite to check.
     * @param x The X position.
     ...
     *
     * This method sets the foreground color of the sprite at the given
     * position. The position is specified by the X and Y coordinates, where (0,
     * 0) is the top-left corner of the sprite. If the position is out of
     * bounds, the method will return 0.
     *
     * This method will also redraw the sprite if it is currently drawn.
     * @param sprite The sprite to modify.
     * @param x The X position in the sprite.
     ...
     * @return 1 if the color was set, 0 if the position is out of bounds or an
     * error occurred.
     */
     ...
     *
     * This method sets the background color of the sprite at the given
     * position. The position is specified by the X and Y coordinates, where (0,
     * 0) is the top-left corner of the sprite. If the position is out of
     * bounds, the method will return 0.
     *
    ...
    /**
     * @brief Sets a foreground gradient using RGB colors for a specified
     * section of the sprite.
     *
     * This method sets a foreground gradient using RGB colors between multiple
     * colors. The gradient will be applied to the sprite starting at the given
     * position and extending for the given width and height. The direction of
     * the gradient will be determined by the `direction` parameter. The colors
     * should be specified as RGB values in the format `0xRRGGBB`. Non-integer
     ...
     *
     * This method sets a foreground gradient using RGB colors between multiple
     * colors. The gradient will be applied to the entire sprite. The direction
     * of the gradient will be determined by the `direction` parameter. The
     * colors should be specified as RGB values in the format `0xRRGGBB`.
    ...
    int Sprite_setForegroundGradientAll(
        CmdFX_Sprite* sprite, enum CmdFX_GradientDirection direction,
        int numColors, ...
    );

    /**
     * @brief Sets a background gradient using RGB colors for a specified
     * section of the sprite.
     *
     * This method sets a background gradient using RGB colors between multiple
     * colors. The gradient will be applied to the sprite starting at the given
     * position and extending for the given width and height. The direction of
     * the gradient will be determined by the `direction` parameter. The colors
     * should be specified as RGB values in the format `0xRRGGBB`. Non-integer
     ...
     * will be rotated around its center. If an error occurs, the method will
     * return 0.
     *
     * This method will also redraw the sprite if it is currently drawn.
     *
     ...
     *
     * This method returns the rotation angle of the sprite in radians. The
     * angle will be between -PI and PI. If the sprite is not rotated, the
     * method will return 0. Rotation is calculated by the number of whitespace
     * characters in the sprite, meaning this method relies on whether it is
     * visually rotated or not.
     *
     ...
     *
     * This method scales the sprite by the given factor. The sprite will be
     * scaled around its center. If an error occurs, the method will return 0.
     *
     * This method will also redraw the sprite if it is currently drawn.
     *
     ...
     *
     * This method transposes the sprite, swapping the rows and columns. If an
     * error occurs, the method will return 0.
     *
     * This method will also redraw the sprite if it is currently drawn.
     *
