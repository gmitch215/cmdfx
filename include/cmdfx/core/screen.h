...
/**
 * @brief Gets the size of the terminal window, and stores it in the width
...
/**
 * @brief Gets the size of the screen, and stores it in the width and height
 * variables.
...
/**
 * @brief Gets the position of the mouse, and stores it in the x and y
 * variables.
 *
 * This method gets the position of the mouse on the screen. The x and y
 * variables will be updated with the x and y position of the mouse.
 *
 ...
 *
 * This method gets whether or not line buffering is enabled on the
 * terminal. Line buffering is when the terminal waits for a newline
 * character before sending the input to the program. This must be disabled
 * in order to listen for individual key presses, otherwise events will only
 * pass if the user presses enter.
 *
 ...
 *
 * This method checks if the program is running in a terminal. This is
 * useful for determining if your setup is correct.`
 *
 ...
 *
 * This method will check if the program is running in a terminal. If it is
 * not, the program will exit and launch the program in a terminal.
 */
