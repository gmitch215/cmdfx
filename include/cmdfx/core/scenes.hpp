...
namespace CmdFX {
    ...
    class Scene final {
        ...
        public:
             ...
             */
            CmdFX_Scene* getScene() { return scene; }
             ...
             * @return `scene->uid` if the scene was registered successfully, or `-1` if an error occurred.
             */
            int registerScene() {
             ...
             * @return The unique identifier of the scene before it was unregistered, or `-1` if an error occurred.
             */
            int unregisterScene() {
             ...
             * 
             * This function scrolls the scene by the specified amount in the x and y directions.
             * The amount is specified by the `dx` and `dy` parameters, which represent the amount to scroll in the x and y directions, respectively.
             * This requires the scene to be registered with the Scene Engine.
             * 
             * @param dx The amount to scroll in the x direction.
             * @param dy The amount to scroll in the y direction.
             * @return `0` if the scene was scrolled successfully, or `-1` if an error occurred.
             */
    ...
    namespace Canvas {
         ...
         * @return A unique pointer to the registered scene, or nullptr if the scene was not found.
         */
