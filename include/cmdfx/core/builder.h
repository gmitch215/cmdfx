...
#pragma region Character Builder
     ...
     *
     * This method checks if two 2D Character Arrays are the same size. If the
     * two arrays are the same size, the method will return 1. If the two arrays
     * are not the same size, the method will return 0.
     *
     * @param array1 The first 2D Character Array.
     * @param array2 The second 2D Character Array.
     * @return 1 if the arrays are the same size, 0 if the arrays are not the
     * same size.
     */
     ...
     *
     * This method compares two 2D Character Arrays. If the two arrays are
     * equal, the method will return 0. If the two arrays are not equal, the
     ...
     * coordinates. If the x or y coordinate is out of bounds, the method will
     * return -1.
     *
     * @param array The 2D Character Array.
     ...
     *
     * This method draws a horizontal line in a 2D Character Array. If the x or
     * y coordinate is out of bounds, the method will return -1. If the line
     * goes out of bounds, the line will be cropped.
     ...
     *
     * This method draws a vertical line in a 2D Character Array. If the x or y
     * coordinate is out of bounds, the method will return -1. If the line goes
     * out of bounds, the line will be cropped.
     * @param array The character array.
     * @param x The x coordinate.
     * @param y The y coordinate.
     ...
     *
     * This method draws a rectangle in a 2D Character Array. If the x or y
     * coordinate is out of bounds, the method will return -1. If the rectangle
     * goes out of bounds, the rectangle will be cropped.
     * @param array The character array.
     * @param x The x coordinate.
     * @param y The y coordinate.
     ...
     *
     * This method draws a polygon in a 2D Character Array. If the x or y
     * coordinate is out of bounds, the method will return -1. If the polygon
     * goes out of bounds, the polygon will be cropped.
     *
     * @param array The character array.
     * @param x The x coordinate.
     * @param y The y coordinate.
     ...
     *
     * This method fills a polygon in a 2D Character Array. If the x or y
     * coordinate is out of bounds, the method will return -1. If the polygon
     * goes out of bounds, the polygon will be cropped.
     *
     * @param array The character array.
     ...
     *
     * This method resizes a 2D Character Array to a specific width and height.
     * If the new width or height is smaller than the original width or height,
     * the 2D Character Array will be cropped. If the new width or height is
     * larger than the original width or height, the 2D Character Array will be
    ...
    /**
     * @brief Resizes a 2D Character Array to a specific width and height with
     * padding.
     *
     * This method resizes a 2D Character Array to a specific width and height
     * with padding. If the new width or height is smaller than the original
     * width or height, the ASCII art character will be cropped. If the new
     * width or height is larger than the original width or height, the 2D
     * Character Array will be padded with the specified character.
     *
     * @param array The 2D Character Array.
     * @param width The new width.
     * @param height The new height.
     ...
     *
     * This method centers a 2D Character Array both horizontally and
     * vertically. It will reposition the characters depending on whether there
     ...
     *
     * This method resizes and centers a 2D Character Array to a specific width
     * and height. If the new width or height is smaller than the original width
     * or height, the ASCII art character will be cropped. If the new width or
     * height is larger than the original width or height, the 2D Character
     * Array will be padded with the specified character.
     *
     * @param array The 2D Character Array.
     * @param width The new width.
     * @param height The new height.
     ...
     *
     * This method rotates a 2D Character Array by a specific number of radians.
     * The rotation will be done around the center of the 2D Character Array.
     *
     * @param array The 2D Character Array.
     ...
     *
     * This method returns the rotation angle of a 2D Character Array in
     * radians. The angle will be between -PI and PI. If the 2D Character Array
     * is not rotated, the method will return 0. Rotation is calculated by the
     * number of whitespace characters in the 2D Character Array, meaning this
     * method relies on whether it is visually rotated or not.
     *
     * @param array The 2D Character Array.
     ...
     * @return The number of characters replaced, 0 if none, or -1 if an error
     * occurred.
     */
     ...
     *
     * This method creates a multi-gradient in a 2D Character Array. The
     * gradient will be created from the start character to the end character.
     * The gradient will be created in the specified direction.
     *
    ...
    int Char2DBuilder_multiGradients(
        char** array, int x, int y, int width, int height, int numChars,
        char* gradient, double* percentages,
        enum CmdFX_GradientDirection direction
    );
     ...
     *
     * This method creates a full gradient in a 2D Character Array. The gradient
     * will be created from the start character to the end character. The
     * gradient will be created in the specified direction.
     *
    ...
    int Char2DBuilder_gradientFull(
        char** array, char start, char end,
        enum CmdFX_GradientDirection direction
    );
...
#pragma region String Builder
     ...
     * arrays are the same size, the method will return 1. If the two arrays are
     * not the same size, the method will return 0.
     *
     ...
     * the method will return 0. If the two arrays are not equal, the method
     * will return -1.
     *
     * @param array1 The first 2D String Array.
     * @param array2 The second 2D String Array.
    ...
    /**
     * @brief Creates a 2D String Array with a specific width and height, filled
     ...
     *
     * This method draws a polygon in a 2D String Array. If the x or y
     * coordinate is out of bounds, the method will return -1. If the polygon
     * goes out of bounds, the polygon will be cropped.
     *
     * @param array The string array.
     ...
     *
     * This method fills a polygon in a 2D String Array. If the x or y
     * coordinate is out of bounds, the method will return -1. If the polygon
     * goes out of bounds, the polygon will be cropped.
     *
     * @param array The string array.
     ...
     *
     * This method rotates a 2D String Array by a specific number of radians.
     * The rotation will be done around the center of the 2D String Array.
     *
     * @param array The 2D String Array.
     * @param radians The number of radians to rotate.
     * @return 0 if successful, -1 if an error occurred.
     ...
     * @return The number of Strings replaced, 0 if none, or -1 if an error
     * occurred.
     */
