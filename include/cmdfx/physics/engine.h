...
extern "C"
{
     ...
     *
     * This method returns the force of gravity, in characters per second
     * squared. The default value is 1.0 c/s^2.
     *
     ...
     *
     * The default friction coefficient is a value between 0 and 1 that
     * determines how much friction is applied to a sprite. A value of 0 means
     * no friction, while a value of 1 means full friction, meaning it will stop
     * immediately.
     *
