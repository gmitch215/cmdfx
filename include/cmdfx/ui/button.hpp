...
class Button {
  ...
  public:
     ...
     * @param data A 1D vector of strings representing the data to set for the
     * button.
     * @param ansi A 2D vector of strings representing the ANSI escape codes to
     * apply to the data.
...
{
/**
 * @brief Gets all registered buttons in the UI manager as a vector of
 * unique_ptr<Button>.
