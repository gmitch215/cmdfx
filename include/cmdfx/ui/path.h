 ...
 * @param dx1 The x coordinate of the top-left corner of the rectangle relative to the current point
 * @param dy1 The y coordinate of the top-left corner of the rectangle relative to the current point
 * @param dx2 The x coordinate of the bottom-right corner of the rectangle relative to the current point
 * @param dy2 The y coordinate of the bottom-right corner of the rectangle relative to the current point
 */
 ...
 * @param dx The x coordinate of the center of the ellipse relative to the current point
 * @param dy The y coordinate of the center of the ellipse relative to the current point
 * @param rx The x radius of the ellipse
 * @param ry The y radius of the ellipse
 * @param x_axis_rotation The rotation of the ellipse in degrees
 */
 ...
 * 
 * The function will make no attempt to validate the path string, so it is the
 * responsibility of the caller to ensure that the path string is well-formed
 * and contains valid commands. The function will return -1 if the path string
 * is NULL or if an error occurs while drawing the path.
 * 
